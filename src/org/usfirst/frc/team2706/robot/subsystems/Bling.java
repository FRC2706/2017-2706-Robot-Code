...
public class Bling extends Subsystem {
    ...
    /*
     * Used to tell the bling command whether or not to display green or nothing during autonomous
     */
    ...
    /**
     * Tells other subsystems if the bling system has displayed a battery critical sigh yet.
     * 
    ...
    /**
     * Returns the value of autostate to tell bling command whether or not to display a green during
     * autonomous.
     * 
    ...
    /**
     * Simple function that toggles the value of the distance shower variable.
     */
    ...
    /**
     * Returns the value of the distance shower variable. Used to determine whether or not the
     * drivers want to see distance when lining up.
     * 
     * @return A boolean with the value of whether or not we want to show distance.
     */
    ...
    /**
     * This command will toggle if we're displaying flashy patterns in case of possible complaints,
     * a button on the driver joystick will call this to toggle it.
     */
    public void toggleFlashiness() {
        ...
        if (!flashyOff) {
            ...
            // If the command was lower than 9, show a command 6.
                ...
                command = ("F6C" + lastCommand.get("colour") + "D" + lastCommand.get("delay") + "B"
                                + lastCommand.get("brightness") + "P"
                                + lastCommand.get("startPoint") + "Q" + lastCommand.get("endPoint")
                                + "R500E6Z");

            else
                command = ("F12C" + lastCommand.get("colour") + "D" + lastCommand.get("delay") + "B"
                                + lastCommand.get("brightness") + "R500E12Z");
        } else {
            flashyOff = false;
            ...
            if (lastCommand.get("pattern") == "0")
                ...
                command = ("F" + lastCommand.get("pattern") + "C" + lastCommand.get("colour") + "D"
                                ...
                                + "P" + lastCommand.get("startPoint") + "Q"
                                + lastCommand.get("endPoint") + "R500E" + lastCommand.get("pattern")
                                + "Z");
    ...
    /**
     * Used to show if there is an error. Will be red if there is, green otherwise.
     * 
     ...
     * @param pegIn Will be true if the peg is in the hole, false otherwise.
     */
