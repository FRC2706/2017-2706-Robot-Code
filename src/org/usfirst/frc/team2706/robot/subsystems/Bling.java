...
public class Bling extends Subsystem {
    ...
    /*Will be true if the battery level is critical, in which case it will override all
    ...
    */
	 ...
	 * Starts the teleop period for the bling
	 */
	...
	public void showReadyToReceiveGear(boolean ready) {
	  //Do not interfere with critical battery warning.
	    if (ready && !batCritical) display("Green", 3, -1, 2, 100, 0, 120); 
	}
	/**
