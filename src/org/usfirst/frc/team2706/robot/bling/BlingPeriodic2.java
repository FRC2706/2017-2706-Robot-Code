 ...
 * @see <a href =
 *      "https://docs.google.com/spreadsheets/d/1zb40w_BbmzKFPKRT7XTrjqsIKUw0Jn152sTJA3ppQCs/edit?usp=sharing">
...
public class BlingPeriodic2 extends Command {
    ...
    /*
     * True if we were just lining up for gear. To avoid showing the peg line-up pattern right after
     * gear pickup.
     */
    ...
    protected void execute() {
        ...
        // Teleop display modes
                        ...
                        && Robot.blingSystem.getSpecialState() == "") {
            ...
            /*
             * Turn off the rumbler at an appropriate time (when the peg is no longer in or arms are
             * open).
             */
            ...
            else if (!gearPickupPattern && distance < outsideDistanceThreshold
                            && ((1 <= gearState && gearState <= 3) || gearState == 5)) {
            ...
            // Displaying pickup line up
                ...
                if ((lowerDistanceThreshold <= distance) && (distance <= upperDistanceThreshold)
                                && gearState == 0)
    ...
    /**
     * Used to make sure that when we back up from picking up a gear, there is a delay before the
     * peg line up pattern can be displayed.
     */
