...
/* position 5: Right position place gear > launch */ new SideStartSideGear(true, 0.6, 7, 45, 5, 2, 20),
 ...
 /* position 9: Left/ gear double side hopper pop */ new QuickRotate(90),
      ...
      /* position 11: Left gear middle hopper pop */ new SideGearCurve(0.6,5,8.75,65,4,5),
     /* position 12: Right gear middle hopper pop */ new StraightDriveWithEncoders(-0.6,-4.0,1)
        );
