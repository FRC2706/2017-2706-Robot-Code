...
public class RobotMap {
     ...
     * 
     * Accessing constants with RobotMap is the same as usual, however, to add a new constant, you
     * must first add the constant to RobotMap with new value. Then create the same constant into
     * each nested class, with the value for each robot. Next in the static block, add a local
     * variable of the same type, initialized to 0. Go to the switch statement and set the local
     * variable to the nested class version of the constant. Finally, go to the last part of the
     * static block and set the RobotMap constant to the local variable.
     * 
     * TL;DR (TODO)
     * 
