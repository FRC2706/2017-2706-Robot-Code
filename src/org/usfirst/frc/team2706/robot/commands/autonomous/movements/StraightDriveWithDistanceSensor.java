...
public class StraightDriveWithDistanceSensor extends Command {
     ...
     */
    public StraightDriveWithDistanceSensor(double speed, double distance, int minDoneCycles,
                    double error) {
        ...
        leftPID = new PIDController(P, I, D, Robot.driveTrain.getDistanceSensorPIDSource(),
                        Robot.driveTrain.getDrivePIDOutput(false, true));

        rightPID = new PIDController(P, I, D, Robot.driveTrain.getDistanceSensorPIDSource(),
