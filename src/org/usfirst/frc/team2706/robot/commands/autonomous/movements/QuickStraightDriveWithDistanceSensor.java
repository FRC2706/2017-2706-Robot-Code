...
public class QuickStraightDriveWithDistanceSensor extends Command {
     ...
     * @param alpha The amount of weight given to the current value compared to the overall average
     *        (between 0 and 1)
     */
    public QuickStraightDriveWithDistanceSensor(double speed, double distance1, double distance2,
                    int desiredStopCycles, double alpha) {
